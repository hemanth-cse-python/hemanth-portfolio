    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-md bg-gradient-brand px-5 py-2.5 text-sm font-medium text-white"
          >
            Go home
          </Link>
        </div>
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Person",
          name: "Sripathi Hemanth",
          jobTitle: "Python Full Stack Developer",
          url: "/",
          sameAs: [
            "https://github.com/hemanth-cse-python",
